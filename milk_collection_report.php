...
<head>
  ...
  <title>Milk Collection Report - Digital Dairy</title>
...
<div class="content" id="mainContent">
  ...
  <div class="page-header">
    <h1><i class="fas fa-tint"></i> Milk Collection Report</h1>
    <p>Generate detailed milk collection reports with advanced filtering and export options</p>
  </div>
  ...
  <div class="summary-cards">
    <div class="summary-card">
      ...
      <div class="summary-content">
        <h4 id="totalQuantity">0.00 L</h4>
        <p>Total Milk Quantity</p>
      </div>
    </div>
    <div class="summary-card">
    ...
    <form method="POST" class="form-row">
      ...
      <div class="form-group">
        ...
        <select id="product_type" name="product_type" class="form-control">
          ...
          <option value="Cow Milk" <?php echo (isset($_POST['product_type']) && $_POST['product_type'] == 'Cow Milk') ? 'selected' : ''; ?>>Cow Milk</option>
          <option value="Buffalo Milk" <?php echo (isset($_POST['product_type']) && $_POST['product_type'] == 'Buffalo Milk') ? 'selected' : ''; ?>>Buffalo Milk</option>
          <option value="Goat Milk" <?php echo (isset($_POST['product_type']) && $_POST['product_type'] == 'Goat Milk') ? 'selected' : ''; ?>>Goat Milk</option>
        </select>
      </div>
  ...
  <div class="table-container" id="resultsContainer" style="display: <?php echo isset($_POST['search']) ? 'block' : 'none'; ?>;">
    <div class="table-header">
      <h3><i class="fas fa-table"></i> Milk Collection Details</h3>
    </div>

    <div style="padding: 0 30px 30px 30px;">
      <table id="milkCollectionTable" class="display nowrap" style="width:100%">
        <thead>
          <tr>
            ...
            <th><i class="fas fa-weight"></i> Quantity (L)</th>
        ...
        <tbody>
          ...
          if(isset($_POST['search'])){
            ...
            $sql = "SELECT mc.id, mc.date, f.name AS farmer, mc.product_type, mc.quantity,
                    ...
                    JOIN farmers f ON f.uuid = mc.farmer_uuid
                    WHERE mc.date BETWEEN '$from' AND '$to'";

            if(!empty($product_type)) {
              $sql .= " AND mc.product_type = '$product_type'";
            }
...
<style>
  :root {
    ...
    * {
    ...
    #milkCollectionTable tbody td {
      padding: 14px 16px;
      border-bottom: 1px solid var(--gray-200);
      font-size: 14px;
    }

    #milkCollectionTable tbody tr:hover {
      background: rgba(102, 126, 234, 0.05);
    }

    #milkCollectionTable tbody tr:nth-child(even) {
...
$(document).ready(function() {
    ...
    var table = $('#milkCollectionTable').DataTable({
        dom: 'Bfrtip',
        buttons: [
            {
                extend: 'copy',
        ...
        language: {
            ...
            info: "Showing _START_ to _END_ of _TOTAL_ milk collections",
            paginate: {
                first: "First",
                last: "Last",
                next: "Next",
    ...
    $('#totalQuantity').text('<?php echo number_format($totalQuantity, 2); ?> L');
    $('#totalPayment').text('₹<?php echo number_format($totalPayment, 2); ?>');
