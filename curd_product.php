...
<head>
    ...
    <title>Curd Products - Digital Dairy Management System</title>
    ...
    <style>
        ...
        .hero-section {
            background: linear-gradient(var(--dark-overlay), var(--dark-overlay)),
                        url('https://images.unsplash.com/photo-1628773822503-930a7eaecf80?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80');
    ...
    <div class="full-width-container">
        ...
        <section class="hero-section">
            <div class="hero-content">
                <h1 class="hero-title">Curd Products</h1>
                <p class="hero-subtitle">Fresh, creamy curd and yogurt products made from pure milk</p>
        ...
        <section id="products" class="products-section">
            <div class="container">
                <h2 class="section-title">Our Curd Products</h2>

                <div class="row">
                    <?php
                    // Fetch only curd products from database
                    $ret = mysqli_query($con, "SELECT * FROM tblproduct WHERE ProductType LIKE '%Curd%' ORDER BY ID DESC");
                    ...
                    ?>
                        <div class="col-12">
                            <div class="no-products">
                                <i class="fas fa-ice-cream"></i>
                                <h3>No Curd Products Available</h3>
                                <p>There are currently no curd products in our inventory. Please check back later or contact us for more information.</p>
                            </div>
                        </div>
                    <?php
                    }
